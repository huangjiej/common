...
public class ValidateException extends BusinessException {
	 ...
	 * 签名验证失败（SHA1)
	 */
	public static final SignatureException   ERROR_SIGNATURE_SHA1=new SignatureException(10302, "签名验证失败（SHA1)");
	/**
	 * 签名验证失败（RSA)
	 */
	public static final SignatureException   ERROR_SIGNATURE_RSA=new SignatureException(10303, "签名验证失败（RSA)");
	/**
	 * 签名验证失败（ECC)
	 */
	 ...
	 * 无效URL地址
	 */
	public static final RequestException 	 ERROR_REQUEST_INVALID=new RequestException(10501, "无效URL地址");
	/**
	 * 应用无权限访问
	 */
	public static final AuthorityException 	 ERROR_PREMISSION_DENIED=new AuthorityException(10601, "应用无权限访问");
	...
	static {
		...
		ERROR_SIGNATURE_ECC.baseException=true;
		...
		ERROR_REQUEST_INVALID.baseException=true;
	...
	public static void main(String[] args) {
		Object a = ValidateException.ERROR_SIGNATURE_RSA.clone(new Exception());
